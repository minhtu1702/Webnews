...
/**
 * Title: Contact 002
 * Slug: newslink-magazine/contact-002
 * Categories: contact
 */
?>
...
<figure class="wp-block-image aligncenter size-large"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/content/content-5.png");?>" alt="" class="wp-image-2025"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->